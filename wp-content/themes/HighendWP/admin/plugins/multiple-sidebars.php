...
class sidebar_generator {
	...
	function sidebar_generator(){
		...
		//edit posts/pages ISKLJUCIO SAM - UBACUJE U META NESTO.
	...
	function admin_menu(){
		add_theme_page('Sidebar Manager', 'Sidebar Manager', 'manage_options', 'multiple_sidebars', array('sidebar_generator','admin_page'));
