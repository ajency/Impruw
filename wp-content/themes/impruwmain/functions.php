<?php
    ...
    function register_required_scripts()
    {
        ...
        if (is_page_template('page-register.php') || is_page_template('page-login.php')) {
            ...
            wp_enqueue_script('parsley.remote', get_template_directory_uri() . '/js/parsley.remote.js',array('jquery'), '', TRUE);
            wp_enqueue_script('parsley', get_template_directory_uri() . '/js/parsley/parsley.js', array('jquery','parsley.remote'), '1.2.1', TRUE);
