    ...
    <div class="aj-imp-block-list">
		<ul>
			...
			<li class="block">
				...
				<img src="<?php echo get_template_directory_uri(); ?>/<?php echo get_language_based_image_path(); ?>/BlueBoldThemeScreen.jpg" class="img-responsive"> 
			...
			<li class="block">
				...
				<img src="<?php echo get_template_directory_uri(); ?>/<?php echo get_language_based_image_path(); ?>/ClassicGreenThemeScreen.jpg" class="img-responsive"> 
			...
			<li class="block">
				...
				<img src="<?php echo get_template_directory_uri(); ?>/<?php echo get_language_based_image_path(); ?>/PinkThemeScreen.jpg" class="img-responsive"> 
			...
			<li class="block">
				...
				<img src="<?php echo get_template_directory_uri(); ?>/<?php echo get_language_based_image_path(); ?>/NeonThemeScreen.jpg" class="img-responsive"> 
