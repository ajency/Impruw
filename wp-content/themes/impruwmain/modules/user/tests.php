<?php
    ...
    class UserFunctionsTest extends WP_UnitTestCase
    {
        ...
        {
            return array(array('Suraj', 'Air', 'Suraj Air'), array('Suraj', 'Air', 'Suraj Krishna Air '),);
        }
        ...
        {
            $num       = rand(00, 100);
            $user_data = array('user_email' => 'email' . $num . '@mailinator.com', 'display_name' => 'New User' . $num, 'user_pass' => 'user');
