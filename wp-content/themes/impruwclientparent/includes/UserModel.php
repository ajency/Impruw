<?php
    ...
    class ImpruwUser extends WP_User
    {
        ...
        function get_user_basic_info()
        {
            ...
            return array('id' => $this->data->ID, 'userLogin' => $this->data->user_login, 'userEmail' => $this->data->user_email, 'displayName' => $this->data->display_name, 'roles' => $this->roles, 'capabilities' => $this->allcaps, 'defaultLanguage' => $this->get_site_language());
        }
        ...
        function save_user_profile($user_data)
        {
            ...
            $new_user_data = array('ID' => $user_data['ID'], 'user_email' => $user_data['general']['user_email'], 'display_name' => $user_data['general']['display_name']);

            $email_user = email_exists($user_data['general']['user_email']);


            if (isset($user_data['general']['new_feature_alert']))
                update_user_meta($user_data['ID'], 'impruw_featurealert', $user_data['general']['new_feature_alert']); else
