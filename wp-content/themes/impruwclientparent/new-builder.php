            ...
            <div class="modal-body">
                <ul class="color-set-list">
                    <li>
                        <div class="thumbnail">
                            <div class="colors">
                                <span style="background: #FF5F5F;" data-toggle="tooltip"
                                      title="Primary Color for Theme">&nbsp;</span>
                            ...
                            <div class="caption">
                                ...
                                <p>
                                    <a href="#" class="btn btn-xs btn-primary" role="button"><span
                                            class="glyphicon glyphicon-check"></span> Apply</a>
                                    <a href="#" class="btn btn-xs btn-default" role="button"><span
