	...
	App.module 'DashboardApp.Statistics.SiteAnalytics.Views', (Views, App, Backbone, Marionette, $, _)->
		...
		class Views.TrafficViewChart extends Marionette.CompositeView
			...
			template : '<h4> All Traffic Data</h4>
						...
						<div class="row traffic-list-table"><div class="col-md-12">
						<table class="traffic-list table table-striped">
						<thead><tr><th class="text-left">Source</th><th >Visits</th><th>Page views</th><th>Avg time on the page</th><th>Bounce rate</th></tr></thead>
						<tr>
						<td class="text-left" data-title="Source"><a href="#">http://dribbble.com/shots/popular? </a><span class="label label-info">R</span></td><td data-title="Visits">163</td><td data-title="Page views">  2.08 </td><td data-title="Avg time on the page"> 00:12:36     </td><td data-title="Bounce rate"> 70.38%<span class="glyphicon glyphicon-arrow-up"></span></td></tr>
						<td class="text-left" data-title="Source"><a href="#">http://dribbble.com/shots/popular? </a><span class="label label-danger">O</span></td><td data-title="Visits">163</td><td data-title="Page views">  2.08 </td><td data-title="Avg time on the page"> 00:12:36     </td><td data-title="Bounce rate"> 70.38%<span class="glyphicon glyphicon-arrow-down"></span></td></tr>
						</table></div></div>'
