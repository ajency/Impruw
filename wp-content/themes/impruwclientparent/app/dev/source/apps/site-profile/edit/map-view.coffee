	...
	App.module 'SiteProfileApp.Edit.View',(View,App)->
		...
		class View.MapView extends Marionette.ItemView
			...
			template : '<div class="form-group">
							<div id="map-preview-top-info" class="col-sm-12">
								<div class="help-block default-position default-text hide"> 
									<span class="icon icon-info2"></span>&nbsp;
									<span>Position not accurate? Move the marker to set to accurate position.</span>
								</div>
								<div class="help-block default-position not-found-text hide"> 
									<span class="icon icon-info2"></span>&nbsp;
									<span>Your address could not be found. Move the marker to your address.</span>
								</div>
								<div class="help-block custom-position clearfix hide">
									<span class="icon icon-info2"></span>&nbsp;
									<span>Now showing custom position. Click on default button to show default.</span>
									<div class="buttons pull-right">
										<button class="custom-position hide btn btn-default btn-xs aj-imp-orange-btn set-default-position" type="button">Show Default</button>
									</div>
								</div>
							</div>
						</div>
