define [ 'app', 'controllers/base-controller', 'bootbox' ], ( App, AppController, bootbox )->
	...
	App.module "MenuManager.Show", ( Show, App )->
		...
		class MediaMangerLayout extends Marionette.LayoutView
			...
			events : 
				'click a.delete-menu' : ->
					message = "<h4 class='delete-message'>"+_.polyglot.t('All the occurrences of this menu will be deleted from the website. Are you sure you want to delete the menu?')+"</h4>"
