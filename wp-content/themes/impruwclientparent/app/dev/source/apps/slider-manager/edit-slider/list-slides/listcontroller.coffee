    ...
    App.module 'SliderManager.EditSlider.SlidesList', (SlidesList, App, Backbone, Marionette, $, _)->
        ...
        class SlideView extends Marionette.ItemView
            ...
            saveSlideLayer :(e)->
                    ...
                    data.text = "<h3 class='#{@$el.find('.caption-style').val()}' data-title='#{@$el.find('.caption-title').val()}'>"
                    ...
                    data.text += "</h3><div class='text' data-capdesc='#{@$el.find('.caption-description').val()}'>#{@$el.find('.caption-description').val()}</div>"
