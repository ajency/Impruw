			...
			App.module 'DashboardApp.Statistics', (Statistics, App, Backbone, Marionette, $, _)->
				...
				class StatisticsLayout extends Marionette.Layout
					...
					changeRange:(e)->
						...
						@trigger "radio:clicked" ,startDate, endDate #JsonCollection
				...
				class Statistics.Controller extends AppController
					...
					initialize:->
						...
						@listenTo @layout, 'radio:clicked',(start,end) =>
							...
							@layout.overviewRegion.show @_loadChartOverview(start,end)
						...
						@listenTo @layout, 'show' ,->
							...
							$( "#to" ).datepicker
								...
								onClose: ( selectedDate )->
									...
									#alert $("#from").datepicker("getDate").getMonth()+"   -    "+$("#to").datepicker("getDate")
							...
							$('#daterange-apply').on 'click',->
								...
								self.layout.overviewRegion.show self._loadChartOverview(start,end)   


							
						                 				
							@layout.overviewRegion.show @_loadChartOverview(startDate,endDate)         #analyticsCollection.toJSON())
