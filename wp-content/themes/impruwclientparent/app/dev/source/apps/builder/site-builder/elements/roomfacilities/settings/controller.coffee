define ['app', 'controllers/base-controller', 'apps/builder/site-builder/elements/roomfacilities/settings/views'],
(App, AppController)->
    App.module 'SiteBuilderApp.Element.RoomFacilities.Settings', (Settings, App, Backbone, Marionette, $, _)->
        ...
        App.vent.on "show:roomfacilities:settings:popup", (model)->
