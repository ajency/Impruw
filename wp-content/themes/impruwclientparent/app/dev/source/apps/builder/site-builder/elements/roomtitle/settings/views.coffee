define ['app', 'text!apps/builder/site-builder/elements/roomtitle/settings/templates/settings.html'],
(App, settingsTpl)->

    # Headerapp views
    App.module 'SiteBuilderApp.Element.RoomTitle.Settings.Views', (Views, App, Backbone, Marionette, $, _)->
