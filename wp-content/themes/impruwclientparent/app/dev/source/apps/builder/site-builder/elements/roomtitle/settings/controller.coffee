define ['app','controllers/base-controller','apps/builder/site-builder/elements/roomtitle/settings/views'],
		(App, AppController)->

			App.module 'SiteBuilderApp.Element.RoomTitle.Settings', (Settings, App, Backbone, Marionette, $, _)->
				...
				App.vent.on "show:roomtitle:settings:popup", (model)->
