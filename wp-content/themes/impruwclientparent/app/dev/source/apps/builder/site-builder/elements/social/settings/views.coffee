define ['app', 'text!apps/builder/site-builder/elements/social/settings/templates/settings.html'],
		(App, settingsTpl)->

			# Headerapp views
			App.module 'SiteBuilderApp.Element.Social.Settings.Views', (Views, App, Backbone, Marionette, $, _)->
