define ['app'
        'text!apps/builder/site-builder/elements/accordion/settings/templates/settings.html'
],(App, settingsTpl)->

    # Headerapp views
    App.module 'SiteBuilderApp.Element.Accordion.Settings.Views', (Views, App, Backbone, Marionette, $, _)->
