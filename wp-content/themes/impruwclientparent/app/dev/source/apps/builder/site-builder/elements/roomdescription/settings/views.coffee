define ['app', 'text!apps/builder/site-builder/elements/roomdescription/settings/templates/settings.html'],
(App, settingsTpl)->

    # Headerapp views
    App.module 'SiteBuilderApp.Element.RoomDescription.Settings.Views', (Views, App, Backbone, Marionette, $, _)->
