define ['app', 'text!apps/builder/site-builder/elements/roomfacilities/settings/templates/settings.html'],
(App, settingsTpl)->

    # Headerapp views
    App.module 'SiteBuilderApp.Element.RoomFacilities.Settings.Views', (Views, App, Backbone, Marionette, $, _)->
