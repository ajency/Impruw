define ['app', 'text!apps/builder/site-builder/elements/roomsummary/settings/templates/settings.html'],
		(App, settingsTpl)->
			...
			App.module 'SiteBuilderApp.Element.RoomSummary.Settings.Views', (Views, App, Backbone, Marionette, $, _)->
				...
				class Views.SettingsView extends Marionette.ItemView
					...
					events:
						...
						'change select.room-name': (evt)-> @trigger "element:selection:changed", $(evt.target).val()