...
Your can restore this version at any time from \'Revision History\'.' ),
						...
						e.stopPropagation()
						e.preventDefault()
						@$el.find('.aj-imp-choose-btn').addClass('load-anim').html('<span class="glyphicon glyphicon-info-sign pulse"></span><div class="msg-1"><span class="glyphicon glyphicon-ok"></span> ' +  _.polyglot.t( "Creating pages with demo content." ) + ' </div><div class="msg-2"><span class="glyphicon glyphicon-ok"></span> ' + _.polyglot.t( "Applying the theme colors." ) + ' </div><div class="msg-3"><span class="glyphicon glyphicon-ok"></span> ' + _.polyglot.t( "Prepping up the elements." ) + ' </div><div class="msg-4"><span class="glyphicon glyphicon-ok"></span> ' + _.polyglot.t( "Hang on, we are almost done..." ) + ' </div>').css('display':'block')
						_.delay =>
		                    @$el.find('.msg-1').show().addClass('slideRight')
		                , 1000
		                _.delay =>
