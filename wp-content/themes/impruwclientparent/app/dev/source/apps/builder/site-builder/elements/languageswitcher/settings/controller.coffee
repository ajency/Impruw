define ['app'
        ...
        'apps/builder/site-builder/elements/languageswitcher/settings/views'],
(App, AppController)->
    App.module 'SiteBuilderApp.Element.LanguageSwitcher.Settings', (Settings, App, Backbone, Marionette, $, _)->
        ...
        App.vent.on "show:languageswitcher:settings:popup", (model)->
