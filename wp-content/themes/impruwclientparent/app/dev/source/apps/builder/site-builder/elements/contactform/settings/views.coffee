define ['app', 'text!apps/builder/site-builder/elements/contactform/settings/templates/settings.html'],
		(App, settingsTpl)->

			# Headerapp views
			App.module 'SiteBuilderApp.Element.ContactForm.Settings.Views', (Views, App, Backbone, Marionette, $, _)->
