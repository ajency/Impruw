define ['app'
        ...
        'apps/builder/site-builder/elements/accordion/settings/views'
],(App, AppController)->
    App.module 'SiteBuilderApp.Element.Accordion.Settings', (Settings, App, Backbone, Marionette, $, _)->
        ...
        App.vent.on "show:accordion:settings:popup", (model)->
