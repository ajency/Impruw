define ['app', 'text!apps/builder/site-builder/elements/languageswitcher/settings/templates/settings.html'],
(App, settingsTpl)->

    # Headerapp views
    App.module 'SiteBuilderApp.Element.LanguageSwitcher.Settings.Views', (Views, App, Backbone, Marionette, $, _)->
