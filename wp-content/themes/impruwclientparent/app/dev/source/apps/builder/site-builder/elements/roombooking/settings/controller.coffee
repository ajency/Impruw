define ['app', 'controllers/base-controller', 'apps/builder/site-builder/elements/roombooking/settings/views'],
(App, AppController)->
    App.module 'SiteBuilderApp.Element.RoomBooking.Settings', (Settings, App, Backbone, Marionette, $, _)->
        ...
        App.vent.on "show:roombooking:settings:popup", (model)->
