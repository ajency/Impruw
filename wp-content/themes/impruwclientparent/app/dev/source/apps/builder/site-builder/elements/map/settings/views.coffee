define ['app', 'text!apps/builder/site-builder/elements/map/settings/templates/settings.html'],
		(App, settingsTpl)->

			# Headerapp views
			App.module 'SiteBuilderApp.Element.Map.Settings.Views', (Views, App, Backbone, Marionette, $, _)->
