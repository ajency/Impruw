...
define(['app', 'backbone'], function(App, Backbone) {
  return App.module("Entities.Analytics", function(Analytics, App, Backbone, Marionette, $, _) {
    ...
    Analytics.AnalyticsCollection = (function(_super) {
      ...
      AnalyticsCollection.prototype.startDate = new Date();

      AnalyticsCollection.prototype.endDate = new Date();
    ...
    return App.reqres.setHandler("fetch:analytics", function(startDate, endDate) {
