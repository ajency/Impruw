...
define(['app', 'controllers/base-controller', 'apps/builder/site-builder/elements/contactform/settings/views'], function(App, AppController) {
  return App.module('SiteBuilderApp.Element.ContactForm.Settings', function(Settings, App, Backbone, Marionette, $, _) {
    Settings.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(opt) {
        ...
        model = App.request("get:element:settings:options", 'ContactForm');
    ...
    return App.vent.on("show:contactform:settings:popup", function(model) {
