...
define(['app', 'text!apps/builder/site-builder/elements/gallery/settings/templates/settings.html'], function(App, settingsTpl) {
  return App.module('SiteBuilderApp.Element.Gallery.Settings.Views', function(Views, App, Backbone, Marionette, $, _) {
