...
define(['app', 'controllers/base-controller', 'apps/builder/site-builder/elements/imagewithtext/settings/views'], function(App, AppController) {
  return App.module('SiteBuilderApp.Element.ImageWithText.Settings', function(Settings, App, Backbone, Marionette, $, _) {
    Settings.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(opt) {
        ...
        this.listenTo(view, "element:linkcheck:changed", (function(_this) {
          return function(link_check) {
            return _this.model.set("link_check", link_check);
          };
        })(this));
