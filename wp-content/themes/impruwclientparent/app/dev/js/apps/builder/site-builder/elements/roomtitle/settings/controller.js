...
define(['app', 'controllers/base-controller', 'apps/builder/site-builder/elements/roomtitle/settings/views'], function(App, AppController) {
  return App.module('SiteBuilderApp.Element.RoomTitle.Settings', function(Settings, App, Backbone, Marionette, $, _) {
    Settings.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(opt) {
        ...
        model = App.request("get:element:settings:options", 'RoomTitle');
    ...
    return App.vent.on("show:roomtitle:settings:popup", function(model) {
