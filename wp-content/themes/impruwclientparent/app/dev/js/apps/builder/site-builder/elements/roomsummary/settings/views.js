...
define(['app', 'text!apps/builder/site-builder/elements/roomsummary/settings/templates/settings.html'], function(App, settingsTpl) {
  return App.module('SiteBuilderApp.Element.RoomSummary.Settings.Views', function(Views, App, Backbone, Marionette, $, _) {
