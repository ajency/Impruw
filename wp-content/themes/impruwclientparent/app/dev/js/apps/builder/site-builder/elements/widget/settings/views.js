...
define(['app', 'text!apps/builder/site-builder/elements/widget/settings/templates/settings.html'], function(App, settingsTpl) {
  return App.module('SiteBuilderApp.Element.Widget.Settings.Views', function(Views, App, Backbone, Marionette, $, _) {
    return Views.SettingsView = (function(_super) {
      ...
      SettingsView.prototype.setFields = function() {
        ...
        this.$el.find('select[name="type"]').selectpicker('val', this.eleModel.get('type'));
        return this.$el.find('textarea[name="widgetCode"]').val(this.eleModel.get('widgetCode'));
      };
      ...
      SettingsView.prototype.events = {
        ...
        'blur textarea[name="widgetCode"]': function(evt) {
          return this.trigger('widget:code:changed', $(evt.target).val());
        }
      };
