...
define(['app', 'text!apps/builder/site-builder/elements/accordion/settings/templates/settings.html'], function(App, settingsTpl) {
  return App.module('SiteBuilderApp.Element.Accordion.Settings.Views', function(Views, App, Backbone, Marionette, $, _) {
