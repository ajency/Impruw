...
define(['app', 'text!apps/builder/site-builder/elements/roomdescription/settings/templates/settings.html'], function(App, settingsTpl) {
  return App.module('SiteBuilderApp.Element.RoomDescription.Settings.Views', function(Views, App, Backbone, Marionette, $, _) {
