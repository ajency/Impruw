...
define(['app', 'controllers/base-controller', 'apps/builder/site-builder/elements/roomfacilities/settings/views'], function(App, AppController) {
  return App.module('SiteBuilderApp.Element.RoomFacilities.Settings', function(Settings, App, Backbone, Marionette, $, _) {
    Settings.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(opt) {
        ...
        model = App.request("get:element:settings:options", 'RoomFacilities');
    ...
    return App.vent.on("show:roomfacilities:settings:popup", function(model) {
