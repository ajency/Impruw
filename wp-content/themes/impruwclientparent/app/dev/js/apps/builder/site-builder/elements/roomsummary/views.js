...
define(['app'], function(App) {
  return App.module('SiteBuilderApp.Element.RoomSummary.Views', function(Views, App, Backbone, Marionette, $, _) {
    return Views.RoomSummaryView = (function(_super) {
      ...
      RoomSummaryView.prototype.singleRoomTemplate = '<div class="room-summary-container "> <div class="room-summary-title"> <h4>Room Summary</h4> </div> <div class="room-summary"> <div class="room-summary-item"> <span class="key">No. of Rooms : </span> <span class="value">Visible on live</span> </div> <div class="room-summary-item"> <span class="key">Check-in : </span> <span class="value">{{checkin_time}}</span> </div> <div class="room-summary-item"> <span class="key">Check-out : </span> <span class="value">{{checkout_time}}</span> </div> <div class="room-summary-item"> <span class="key">Additional policy : </span> <span class="value">{{additional_policy}}</span> </div> </div> </div>';
