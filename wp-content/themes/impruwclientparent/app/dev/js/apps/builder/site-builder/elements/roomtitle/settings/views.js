...
define(['app', 'text!apps/builder/site-builder/elements/roomtitle/settings/templates/settings.html'], function(App, settingsTpl) {
  return App.module('SiteBuilderApp.Element.RoomTitle.Settings.Views', function(Views, App, Backbone, Marionette, $, _) {
