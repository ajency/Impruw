...
define(['app', 'controllers/base-controller', 'apps/builder/site-builder/elements/tabs/settings/views'], function(App, AppController) {
  return App.module('SiteBuilderApp.Element.Tabs.Settings', function(Settings, App, Backbone, Marionette, $, _) {
    ...
    return App.vent.on("show:tabs:settings:popup", function(model) {
