...
define(['app', 'controllers/base-controller', 'apps/builder/site-builder/elements/roombooking/settings/views'], function(App, AppController) {
  return App.module('SiteBuilderApp.Element.RoomBooking.Settings', function(Settings, App, Backbone, Marionette, $, _) {
    Settings.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(opt) {
        ...
        model = App.request("get:element:settings:options", 'RoomBooking');
    ...
    return App.vent.on("show:roombooking:settings:popup", function(model) {
