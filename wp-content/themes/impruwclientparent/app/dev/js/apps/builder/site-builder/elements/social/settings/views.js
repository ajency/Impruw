...
define(['app', 'text!apps/builder/site-builder/elements/social/settings/templates/settings.html'], function(App, settingsTpl) {
  return App.module('SiteBuilderApp.Element.Social.Settings.Views', function(Views, App, Backbone, Marionette, $, _) {
