...
define(['app', 'controllers/base-controller', 'apps/builder/site-builder/elements/widget/settings/views'], function(App, AppController) {
  return App.module('SiteBuilderApp.Element.Widget.Settings', function(Settings, App, Backbone, Marionette, $, _) {
      ...
      Controller.prototype.initialize = function(opt) {
        ...
        this.listenTo(view, 'element:type:changed', (function(_this) {
          return function(type) {
            return _this.model.set('type', type);
          };
        })(this));
    ...
    return App.vent.on("show:widget:settings:popup", function(model) {
