...
define(['app', 'text!apps/builder/site-builder/elements/roombooking/settings/templates/settings.html'], function(App, settingsTpl) {
  return App.module('SiteBuilderApp.Element.RoomBooking.Settings.Views', function(Views, App, Backbone, Marionette, $, _) {
