...
define(['app', 'controllers/base-controller', 'apps/builder/site-builder/elements/list/settings/views'], function(App, AppController) {
  return App.module('SiteBuilderApp.Element.List.Settings', function(Settings, App, Backbone, Marionette, $, _) {
    Settings.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(opt) {
        ...
        this.listenTo(view, 'element:align:changed', (function(_this) {
    ...
    return App.vent.on("show:list:settings:popup", function(model) {
