...
define(['app', 'controllers/base-controller', 'apps/builder/site-builder/elements/languageswitcher/settings/views'], function(App, AppController) {
  return App.module('SiteBuilderApp.Element.LanguageSwitcher.Settings', function(Settings, App, Backbone, Marionette, $, _) {
    Settings.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(opt) {
        ...
        model = App.request("get:element:settings:options", 'LanguageSwitcher');
    ...
    return App.vent.on("show:languageswitcher:settings:popup", function(model) {
