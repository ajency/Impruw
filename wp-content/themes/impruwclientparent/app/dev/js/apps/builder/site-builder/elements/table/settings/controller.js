...
define(['app', 'controllers/base-controller', 'apps/builder/site-builder/elements/table/settings/views'], function(App, AppController) {
  return App.module('SiteBuilderApp.Element.Table.Settings', function(Settings, App, Backbone, Marionette, $, _) {
    ...
    return App.vent.on("show:table:settings:popup", function(model) {
