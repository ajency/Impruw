  ...
  return App.module('ChangeThemeFontApp.Views', function(Views, App) {
    ...
    return Views.ThemeFontSetView = (function(_super) {
      ...
      ThemeFontSetView.prototype.initialize = function() {
        ...
        return this.secClasses = '.menu-collapser, .title.page-title, .title.action-title, .room-title-container .room-title h1 , .roomsummary .room-title, .booking-title, .room-facilities-container .room-facilities-title h4';
      };
