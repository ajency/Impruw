...
define(['app', 'controllers/base-controller', 'apps/builder/site-builder/elements/text/settings/views'], function(App, AppController) {
  return App.module('SiteBuilderApp.Element.Text.Settings', function(Settings, App, Backbone, Marionette, $, _) {
