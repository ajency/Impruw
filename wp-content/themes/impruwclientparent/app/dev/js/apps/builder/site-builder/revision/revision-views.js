...
define(['app', 'bootbox'], function(App, bootbox) {
  return App.module("SiteBuilderApp.Revision.Views", function(Views, App) {
    ...
    RevisionSingleView = (function(_super) {
      ...
      RevisionSingleView.prototype.template = '<div class="ui-slider-segment {{backup_type}}-backup" {{#notFirst}}style="margin-left: {{segmentGap}};"{{/notFirst}} title="{{author}} - {{post_modified}}"></div>';
