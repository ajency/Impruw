...
define(['app', 'text!apps/builder/site-builder/elements/text/settings/templates/settings.html'], function(App, settingsTpl) {
  return App.module('SiteBuilderApp.Element.Text.Settings.Views', function(Views, App, Backbone, Marionette, $, _) {
    return Views.SettingsView = (function(_super) {
      ...
      SettingsView.prototype.setFields = function() {
        if (this.eleModel.get('draggable') === true) {
          return this.$el.find('input[name="draggable"]').radiocheck('check');
        }
      };
