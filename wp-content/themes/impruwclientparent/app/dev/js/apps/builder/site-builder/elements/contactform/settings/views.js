...
define(['app', 'text!apps/builder/site-builder/elements/contactform/settings/templates/settings.html'], function(App, settingsTpl) {
  return App.module('SiteBuilderApp.Element.ContactForm.Settings.Views', function(Views, App, Backbone, Marionette, $, _) {
