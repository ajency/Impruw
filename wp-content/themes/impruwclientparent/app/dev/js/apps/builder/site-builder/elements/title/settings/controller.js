...
define(['app', 'controllers/base-controller', 'apps/builder/site-builder/elements/title/settings/views'], function(App, AppController) {
  return App.module('SiteBuilderApp.Element.Title.Settings', function(Settings, App, Backbone, Marionette, $, _) {
    ...
    return App.vent.on("show:title:settings:popup", function(model) {
