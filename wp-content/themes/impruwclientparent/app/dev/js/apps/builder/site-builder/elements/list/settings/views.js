...
define(['app', 'text!apps/builder/site-builder/elements/list/settings/templates/settings.html'], function(App, settingsTpl) {
  return App.module('SiteBuilderApp.Element.List.Settings.Views', function(Views, App, Backbone, Marionette, $, _) {
