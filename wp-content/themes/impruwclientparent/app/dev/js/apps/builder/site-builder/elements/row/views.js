  ...
  return App.module('SiteBuilderApp.Element.Row.Views', function(Views, App, Backbone, Marionette, $, _) {
    ...
    return Views.RowView = (function(_super) {
      ...
      RowView.prototype.setColumnResizer = function() {
        ...
        template = '<div class="aj-imp-col-divider"> <p title="' + _.polyglot.t('Move') + '"> <span class="bicon icon-uniF140"></span> </p> </div>';
      ...
      RowView.prototype.setColumnResizerContainment = function() {
        ...
        return _.each(resizers, (function(_this) {
          return function(resizer) {
            ...
            left = _this.$el.offset().left + width / 18;
            if (typeof $(resizer).prev('.aj-imp-col-divider').position() !== 'undefined') {
              left = _this.$el.offset().left + parseFloat($(resizer).prev('.aj-imp-col-divider').css('left')) + width / 18;
            }
            right = _this.$el.offset().left + width - width / 18;
            if (typeof $(resizer).next('.aj-imp-col-divider').position() !== 'undefined') {
              right = _this.$el.offset().left + parseFloat($(resizer).next('.aj-imp-col-divider').css('left')) - width / 18;
            }
