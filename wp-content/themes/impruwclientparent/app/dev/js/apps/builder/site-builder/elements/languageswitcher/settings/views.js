...
define(['app', 'text!apps/builder/site-builder/elements/languageswitcher/settings/templates/settings.html'], function(App, settingsTpl) {
  return App.module('SiteBuilderApp.Element.LanguageSwitcher.Settings.Views', function(Views, App, Backbone, Marionette, $, _) {
