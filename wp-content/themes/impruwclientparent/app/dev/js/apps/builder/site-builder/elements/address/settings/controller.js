...
define(['app', 'controllers/base-controller', 'apps/builder/site-builder/elements/address/settings/views'], function(App, AppController) {
  return App.module('SiteBuilderApp.Element.Address.Settings', function(Settings, App, Backbone, Marionette, $, _) {
    ...
    return App.vent.on("show:address:settings:popup", function(model) {
