...
define(['app', 'controllers/base-controller', 'apps/builder/site-builder/elements/roomdescription/settings/views'], function(App, AppController) {
  return App.module('SiteBuilderApp.Element.RoomDescription.Settings', function(Settings, App, Backbone, Marionette, $, _) {
    ...
    return App.vent.on("show:roomdescription:settings:popup", function(model) {
