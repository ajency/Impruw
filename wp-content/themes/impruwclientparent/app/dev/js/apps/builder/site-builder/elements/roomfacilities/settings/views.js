...
define(['app', 'text!apps/builder/site-builder/elements/roomfacilities/settings/templates/settings.html'], function(App, settingsTpl) {
  return App.module('SiteBuilderApp.Element.RoomFacilities.Settings.Views', function(Views, App, Backbone, Marionette, $, _) {
