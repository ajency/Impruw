...
define(['app', 'controllers/base-controller', 'apps/billing/purchase-history/views'], function(App, AppController) {
  return App.module('BillingApp.PurchaseHistory', function(PurchaseHistory, App, Backbone, Marionette, $, _) {
    ...
    return App.commands.setHandler("show:purchase:app", function(opts) {
