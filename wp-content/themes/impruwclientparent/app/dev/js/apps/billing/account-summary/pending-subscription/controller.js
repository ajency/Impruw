...
define(['app', 'controllers/base-controller'], function(App, AppController) {
  return App.module('BillingApp.PendingSubscription', function(PendingSubscription, App, Backbone, Marionette, $, _) {
    ...
    PendingSubscription.View = (function(_super) {
      ...
      View.prototype.template = '<div> Your subscription to <b>{{plan_name}}</b> plan will begin at the end of current billing cycle. You will be billed for your selected plan on <b> {{start_date}} </b> unless its Free Plan. If you have decided to opt for the Free plan, your current plan will not be renewed and you will lose your domain name.</div>';
