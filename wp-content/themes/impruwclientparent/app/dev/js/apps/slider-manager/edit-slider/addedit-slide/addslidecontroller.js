...
define(['app', 'controllers/base-controller'], function(App, AppController) {
  return App.module('SliderManager.EditSlider.AddSlide', function(AddSlide, App, Backbone, Marionette, $, _) {
    ...
    AddSlideLayout = (function(_super) {
      ...
      AddSlideLayout.prototype.template = '<div id="add-slide-form-region"></div> <div id="media-region" style="display:none"> <ul class="nav nav-tabs"> <li><a href="#upload-media-region" data-toggle="tab">{{#polyglot}}Upload{{/polyglot}}</a></li> <li class="active"><a href="#grid-media-region" data-toggle="tab">{{#polyglot}}Gallery{{/polyglot}}</a></li> </ul> <div class="tab-content"> <div class="tab-pane" id="upload-media-region"></div> <div class="tab-pane active" id="grid-media-region"></div> <button class="btn btn-primary slide-image-selected">{{#polyglot}}Done{{/polyglot}}</button> </div> </div>';
