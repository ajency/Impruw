  ...
  return App.module('SliderManager.EditSlider.SlidesList', function(SlidesList, App, Backbone, Marionette, $, _) {
    ...
    SlideView = (function(_super) {
      ...
      SlideView.prototype.saveSlideLayer = function(e) {
        ...
        data.text += "</h3><div>" + (this.$el.find('.caption-description').val()) + "</div>";
    ...
    SlidesListView = (function(_super) {
      ...
      SlidesListView.prototype.template = ' <div class="slides-list"> <div class="aj-imp-image-header row"> <div class="col-sm-3"> {{#polyglot}}Slide Image{{/polyglot}} </div> <div class="col-sm-9"> {{#polyglot}}Slide Caption{{/polyglot}} </div> </div> <div class="panel-group" id="slides-accordion"></div> </div> <div id="edit-image-view" class="edit-image-view"></div>';
