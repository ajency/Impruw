...
define(['app'], function(App) {
  return App.module('LanguageApp.LanguagePageRooms.OriginalPolicy.Views', function(Views, App, Backbone, Marionette, $, _) {
    return Views.OriginalPolicyView = (function(_super) {
      ...
      OriginalPolicyView.prototype.template = '<div class="form-group"> <label class="col-sm-3 control-label" for="">{{#polyglot}}Additional Policy{{/polyglot}}</label> <div class="col-sm-9 col-sm-offset-3"> <p class="original title">{{additional_policy}} </p> </div> </div>';
