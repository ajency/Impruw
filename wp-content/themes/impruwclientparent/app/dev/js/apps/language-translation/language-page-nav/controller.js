  ...
  return App.module('LanguageApp.LanguagePageNav', function(LanguagePageNav, App, Backbone, Marionette, $, _) {
    LanguagePageNav.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(opts) {
        ...
        this.listenTo(this.languagePageNavView, "menu:translate:content", this.loadMenuContent);
      ...
      Controller.prototype.loadMenuContent = function() {
        return Marionette.triggerMethod.call(this.region, "load:menu:content", this.editingLanguage);
      };
