...
define(['app'], function(App) {
  return App.module('LanguageApp.LanguagePageRooms.OriginalRoomFacilities.Views', function(Views, App, Backbone, Marionette, $, _) {
    ...
    OriginalRoomFacilitiesItemView = (function(_super) {
      ...
      OriginalRoomFacilitiesItemView.prototype.template = ' <div class="form-group"> <label class="col-sm-3 control-label" for="">{{#polyglot}}Facility{{/polyglot}}</label> <div class="col-sm-9 col-sm-offset-3"> <p class="original title">{{name}} </p> </div> </div>';
