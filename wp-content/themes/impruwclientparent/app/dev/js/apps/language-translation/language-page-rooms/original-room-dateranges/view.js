...
define(['app'], function(App) {
  return App.module('LanguageApp.LanguagePageRooms.OriginalRoomDateranges.Views', function(Views, App, Backbone, Marionette, $, _) {
    ...
    OriginalRoomDaterangesItemView = (function(_super) {
      ...
      OriginalRoomDaterangesItemView.prototype.template = ' <div class="form-group"> <label class="col-sm-3 control-label label-head" for="">{{#polyglot}}Date Ranges{{/polyglot}}</label> <div class="col-sm-9 col-sm-offset-3"> <p class="original title">{{daterange_name}} </p> </div> </div>';
