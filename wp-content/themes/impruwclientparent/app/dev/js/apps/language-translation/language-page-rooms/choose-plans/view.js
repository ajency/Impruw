...
define(['app'], function(App) {
  return App.module('LanguageApp.LanguagePageRooms.ChoosePlans.Views', function(Views, App, Backbone, Marionette, $, _) {
    ...
    return Views.ChoosePlansView = (function(_super) {
      ...
      ChoosePlansView.prototype.template = "<div class='row'> <div class='col-sm-7'> <form class='form-horizontal'> <div class='form-group'> <label class='col-sm-3 control-label label-head'>Plans</label> <div class='col-sm-9 col-sm-offset-3'> <select class='js-plan-select' id='js-plan-select'> <option value='-1'>Choose a Plan</option> </select> </div> </div> </form> </div> </div>";
