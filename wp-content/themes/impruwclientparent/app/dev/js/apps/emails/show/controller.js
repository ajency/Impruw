...
define(['app', 'controllers/base-controller', 'apps/emails/show/view', 'apps/emails/user-emails/add-user-email/controller', 'apps/emails/user-emails/edit-user-email/controller'], function(App, AppController) {
