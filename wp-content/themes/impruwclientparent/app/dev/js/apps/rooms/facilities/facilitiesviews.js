...
define(['app'], function(App) {
  return App.module('FacilitiesApp.Views', function(Views, App, Backbone, Marionette, $, _) {
    ...
    return Views.FacilitiesView = (function(_super) {
      ...
      FacilitiesView.prototype.template = '<h4 class="aj-imp-sub-head scroll-ref"> Facilities <small>List the facilities available in this room.</small> </h4> <div class="form-group"> <div class="col-sm-12"> <div class="facilities-list clearfix"></div> </div> </div>';
