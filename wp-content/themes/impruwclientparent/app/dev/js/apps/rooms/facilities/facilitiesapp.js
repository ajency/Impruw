...
define(['app', 'controllers/base-controller', 'apps/rooms/facilities/add/addfacilitiesapp', 'apps/rooms/facilities/list/facilitieslistapp'], function(App, AppController) {
