...
class Accordion extends Element {
     ...
     * @var String 
     */
    var $class_name  = 'accordion-container';
    ...
    function get_open_tag($args = array()){
        $html = "<div class='{$this->get_classes()}' > 
                    <div class='panel-group {$this->style }' id='accordion' role='tablist' aria-multiselectable='true'>";
        return $html;
    }

    function get_close_tag(){
        $html = "</div></div><!--{$this->tag_name}#{$this->id}-->";
        return $html;
    }
