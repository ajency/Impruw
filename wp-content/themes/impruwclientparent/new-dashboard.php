...
<script>
    ...
    var PAYMENT_PLAN_ID =  <?php echo ajbilling_get_user_siteplan_id(get_current_blog_id()); ?>;
    var PLAN_FEATURE_COUNT = { "email_account": [ {"current_count": <?php echo site_feature_current_count('email_account'); ?>,"allowed_count": <?php echo site_feature_allowed_count('email_account'); ?>}],
      "site_add_ons": [ { "current_count": <?php echo site_feature_current_count('site_add_ons'); ?>, "allowed_count": <?php echo site_feature_allowed_count('site_add_ons'); ?> }] };
