...
function google_analytics_object(){
	...
	$client->setAssertionCredentials(
	    new Google_AssertionCredentials(
	        '53154612183-dadqb19o205cv525ibqt26e8ov7pk1rt@developer.gserviceaccount.com', // email you added to GA
	        array('https://www.googleapis.com/auth/analytics.readonly'),
	       file_get_contents("4d754bad091f541088b6080ad9868be405a26c61-privatekey.p12") // keyfile you downloaded
	    )
	);

	// other settings
	$client->setClientId('53154612183-dadqb19o205cv525ibqt26e8ov7pk1rt.apps.googleusercontent.com'); // from API console
