...
<div class="aj-imp-builder container">
    <div class="navbar navbar-default">
        <nav role="navigation" class="aj-imp-builder-top-nav row">
            <div class="aj-imp-builder-back col-sm-2">
                <p class="navbar-text">
                    <a href="<?php echo get_site_url(); ?>/dashboard/"><span
            ...
            <div class="aj-imp-page-layout col-sm-8 clearfix">
                <div class="navbar-text">
                    Page:
                    <div class="btn-group select"><i class="dropdown-arrow dropdown"></i>
                        <button data-toggle="dropdown" class="btn dropdown-toggle clearfix btn-mini btn-default"
                                id="aj-imp-page-sel"><span class="filter-option pull-left">Single Room</span>&nbsp;<span
                                class="caret"></span></button>
                        <ul role="menu" class="dropdown-menu dropdown" style="overflow-y: auto; min-height: 111px;">
                            <li rel="0"><a class="" href="#" tabindex="-1"><span
                                        class="pull-left">Choose Theme</span></a></li>
                            <li rel="1" class="selected"><a class="" href="#" tabindex="-1"><span class="pull-left">Single Room</span></a>
                            </li>
                            <li rel="2"><a class="" href="#" tabindex="-1"><span class="pull-left">Rooms</span></a></li>
                            <li rel="3"><a class="" href="#" tabindex="-1"><span class="pull-left">About Us</span></a>
                            </li>
                            <li rel="4"><a class="" href="#" tabindex="-1"><span class="pull-left">Home</span></a></li>
                            <li rel="5"><a class="" href="#" tabindex="-1"><span class="pull-left">Standard Room</span></a>
                            </li>
                            <li rel="6"><a class="" href="#" tabindex="-1"><span
                                        class="pull-left">Deluxe Room</span></a></li>
                        </ul>
                    </div>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                </div>
    ...
    <div class="aj-imp-builder-area">
        <div class="aj-imp-theme-area">
            ...
            <p class="desc">
                You can choose a theme to be applied across the pages of your site, you will be able to customise your
                theme logo, colours, layout, and components to suit your Site and preferences.
            </p>
                ...
                <ul>
                    <li class="block">
                        ...
                        <div class="aj-imp-choose-btn">
                            <a href="http://classicgreen.unpruwen.com/" class="btn"><span
                                    class="glyphicon glyphicon-ok"></span>&nbsp;Choose</a>
                        </div>
                    </li>
                    <li class="block">
                        <div class="img-holder">
                        ...
                        <div class="aj-imp-choose-btn">
                            <a href="http://pinktheme.unpruwen.com/" class="btn"><span
                                    class="glyphicon glyphicon-ok"></span>&nbsp;Choose</a>
                        </div>
                    </li>
                    <li class="block">
                        ...
                        <div class="aj-imp-choose-btn">
                            <a href="http://bluebold.unpruwen.com/" class="btn"><span
                                    class="glyphicon glyphicon-ok"></span>&nbsp;Choose</a>
                        </div>
                    </li>
                </ul>
