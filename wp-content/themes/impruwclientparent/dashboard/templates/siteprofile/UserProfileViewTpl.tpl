...
<div class="row">
	<div class="aj-imp-dash-content col-md-12">
		...
		<div class="scroll-indicator-container" id="scr1">
			<h4 class="aj-imp-sub-head scroll-ref">General <small>Edit your personal information here</small></h4>
		...
		<div class="scroll-indicator-container" id="scr2">
			<h6 class="aj-imp-sub-head-thin scroll-ref">Change your Password <small>You will be notified of the change by mail</small></h6>
		...
		<div class="scroll-indicator-container" id="scr2">
			<h6 class="aj-imp-sub-head-thin scroll-ref">Change Language <small>This will be the primary language of your website</small></h6>
