                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                    <li role="presentation">
                                        <div class="aj-imp-preview-box">
                                            <h6>Choose Device</h6>
                                            <ul class="clearfix">
                                                <li><a href="#" class="selected"><span class="icon-uniF121"></span></a>
                                                </li>
                ...
                <div class="row second">
                    ...
                    <div class="col-sm-3">
                        <div class="aj-imp-choose-layout" class="dropdown">
                            <a data-toggle="dropdown" href="#" class="aj-imp-layout-btn"><span
                                    class="glyphicon glyphicon-th"></span> Page Layout <span class="caret"></span></a>
                            <ul id="choose-template" class="dropdown-menu pull-right" role="menu"
